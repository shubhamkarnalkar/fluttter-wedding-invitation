...
final Map<String, String> arAR = {
  ...
  // New
  LangTextConstants.lbl_bride: "العروس",
  LangTextConstants.lbl_groom: "العريس",
...
// Variable values
  LangTextConstants.val_address:
      "ماتوشري لونز،\n طريق أكولي-راجور، مفترق إندوري،\n تالك: أكولي، أ.ناغار",
  LangTextConstants.val_bride_name: "مونيكا",
  LangTextConstants.val_groom_name: "مايور"
};
